...
if __name__ == "__main__":
    ...
    best_params = {
        'n_estimators': 6000,
        'learning_rate': 0.006233496372054366,
        'max_depth': 12,
        'min_child_weight': 5,
        'subsample': 0.672963748327069,
        'colsample_bytree': 0.7122842686320227,
        'reg_alpha': 1.7723760758344376,
        'reg_lambda': 6.399391125229494,
        'random_state': 42,
        'device': 'cuda', 
        'tree_method': 'hist',
